<template>
  <div class="marketplace-type-page">
    <div class="hero-banner">
      <div class="hero-content">
        <h1>Scholarships</h1>
        <p>Find funding for your education</p>
      </div>
      <div class="hero-image" />
    </div>
    <div class="type-placeholder">
      <i class="pi pi-gift"></i>
      <p>Scholarship opportunities coming soon.</p>
      <p class="type-hint">Share your credentials to get matched with relevant scholarships.</p>
    </div>
  </div>
</template>
