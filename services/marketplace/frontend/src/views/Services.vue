  ...
  <div class="marketplace-type-page">
    <div class="hero-banner">
      <div class="hero-content">
        <h1>Services</h1>
        <p>Discover services tailored to you</p>
      </div>
      <div class="hero-image" />
    </div>
    <div class="type-placeholder">
      <i class="pi pi-wrench"></i>
      <p>Services marketplace coming soon.</p>
      <p class="type-hint">Share your credentials to get matched with relevant services.</p>
    </div>
  </div>
</template>
